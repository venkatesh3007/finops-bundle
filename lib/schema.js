...
-- The parser is a module (prompt + preprocess/chunk/postprocess) that the system
-- rewrites for itself when you say what went wrong. Versions are per-entity; a
-- candidate is graded on the statements you have already parsed (statement_drafts),
-- scored by the reconciler against each statement's own printed running balance.
