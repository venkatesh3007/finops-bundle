...
THE STATEMENT'S OWN TOTALS — read these off the summary box, they are the strongest
check we have. Most statements print them: a card shows "Opening Balance / New Credits /
New Debits / Closing Balance"; a bank shows "Total Withdrawals / Total Deposits" or
"Total Debit / Total Credit". Copy them EXACTLY as printed, as positive numbers:
  "total_credits" = the printed total of money IN  (payments, deposits, refunds)
  "total_debits"  = the printed total of money OUT (charges, withdrawals, purchases)
Use null for either one the statement does not print. NEVER add these up yourself from
the rows — a total you computed is not a check, it is a tautology. Only ever copy a
figure that is printed on the page.
