...
export async function POST(req) {
  try {
    ...
    if (!extractConfigured()) return Response.json({ error: "extract_not_configured", message: "AI extraction isn't switched on — set AIKAARA_GATEWAY_URL + AIKAARA_GATEWAY_KEY (a dashboard routing-client key) in the app env." }, { status: 503 });
