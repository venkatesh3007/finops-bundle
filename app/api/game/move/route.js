import { resolveReclassify, splitReclassify, splitMany, undoLastFiling, addManualEntry, claimReimbursement, markReview } from "../../../../lib/moves";
...
export async function POST(req) {
  try {
    ...
    else if (action === "undo") result = await undoLastFiling(entity, b);
