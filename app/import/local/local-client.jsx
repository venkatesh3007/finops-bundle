...
export default function ImportClient() {
  ...
  return (
    <div className={s.wrap}>
      <div className={s.top}>
        <h1>Private mode · <span className={s.g}>on-device</span></h1>
        <a className={s.back} href="/import">← Statements (AI extraction)</a>
      </div>
      <p className={s.lede}>Optional, fully local path: pdf.js reads the numbers, your saved decisions/history classify most lines, and an on-device LFM2.5 model (≈0.9 GB download, WebGPU) handles the rest and answers questions. Nothing leaves this browser until you press Import. For most statements the main <a href="/import">AI extraction</a> flow is faster and more accurate.</p>
